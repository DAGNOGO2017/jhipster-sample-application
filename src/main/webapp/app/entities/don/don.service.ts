...
type EntityResponseType = HttpResponse<IDon>;
type EntityArrayResponseType = HttpResponse<IDon[]>;
...
export class DonService {
    ...
    update(don: IDon): Observable<EntityResponseType> {
        return this.http.put<IDon>(this.resourceUrl, don, { observe: 'response' });
    }

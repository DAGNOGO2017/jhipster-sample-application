...
export class ActiviteComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.activiteService
            ...
            .subscribe(
                (res: HttpResponse<IActivite[]>) => this.paginateActivites(res.body, res.headers),
    ...
    registerChangeInActivites() {
        this.eventSubscriber = this.eventManager.subscribe('activiteListModification', response => this.reset());
    }

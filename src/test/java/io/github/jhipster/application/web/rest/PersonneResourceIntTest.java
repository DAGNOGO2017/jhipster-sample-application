...
public class PersonneResourceIntTest {
    ...
    private static final Integer DEFAULT_ID_PERSONNE = 1;
    private static final Integer UPDATED_ID_PERSONNE = 2;
    ...
    public static Personne createEntity(EntityManager em) {
        Personne personne = new Personne()
            .idPersonne(DEFAULT_ID_PERSONNE)
            .nom(DEFAULT_NOM)
    ...
    public void createPersonne() throws Exception {
        ...
        assertThat(testPersonne.getIdPersonne()).isEqualTo(DEFAULT_ID_PERSONNE);
    ...
    public void getAllPersonnes() throws Exception {
        ...
        restPersonneMockMvc.perform(get("/api/personnes?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].idPersonne").value(hasItem(DEFAULT_ID_PERSONNE)))
    ...
    public void getPersonne() throws Exception {
        ...
        restPersonneMockMvc.perform(get("/api/personnes/{id}", personne.getId()))
            ...
            .andExpect(jsonPath("$.idPersonne").value(DEFAULT_ID_PERSONNE))
    ...
    public void updatePersonne() throws Exception {
        ...
        updatedPersonne
            .idPersonne(UPDATED_ID_PERSONNE)
            .nom(UPDATED_NOM)
        ...
        Personne testPersonne = personneList.get(personneList.size() - 1);
        assertThat(testPersonne.getIdPersonne()).isEqualTo(UPDATED_ID_PERSONNE);
